...
urlpatterns = [
    ...
    # path('users/read/<int:page>/', adminapp.users, name='users_page'),
    ...
    path('products/edit/<int:pk>/<int:quantity>/', adminapp.admin_edit_products_quantity, name='edit_quantity'),
